...
extension ContentViewController2: UITableViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if let topViewUnwrappedHeight = topViewCurrentHeightConst {
             ...
             *  3. Skippable - Collapse the header view only when the table view's edge is below the above view - This case will occur if you are using Step 2 of the next condition and have a refresh control in the table view.
             */
             ...
             *  2. The top view's height should be within its maximum height - This is optional. Skipping this step will give a bouncy effect. Note that you need to write extra code in the outer view controller to bring back the view to the maximum possible height.
